---
id: KIT-T245
title: code-graph must NEVER be stale — failsafe required: every --query auto-rebuilds when any indexed file (or the tracked file set) is newer…
